        ...
        <div class="block-bot">
          ...
          <div class="row-articles articles">
            <div class="cl">&nbsp;</div>
              ...
              <div class="cnt">
                <h4 style="display:inline-block;"><a href="#">Name</a></h4>
                 <div style="display:inline-block; float:right;">
                     <asp:SqlDataSource ID="SqlDataSourceGamePlatform" runat="server" ConnectionString="<%$ ConnectionStrings:GameAddictConnectionString %>" SelectCommand="SELECT * FROM [GamePlatform] JOIN [Platform] ON [Platform].PlatformID = [GamePlatform].PlatformID WHERE ([GameID] = @GameID)">
                         <SelectParameters>
                             <asp:Parameter DefaultValue="1" Name="GameID" Type="Int32" />
                         </SelectParameters>
                     </asp:SqlDataSource>
                     <asp:DropDownList ID="platform" runat="server" DataSourceID="SqlDataSourceGamePlatform" DataTextField="Name" DataValueField="Name">
                  ...
                  <div class="rating" style="margin: 10px 10px 10px 0px;">
                      <div class="stars" style="display:inline-block;">
                          ...
                          <span class="star-rating fa fa-star"></span>
                          <span class="star-rating fa fa-star"></span>
                          <span class="star-rating fa fa-star-o"></span>
                          <span class="star-rating fa fa-star-o"></span>
                          <span class="star-rating fa fa-star-o"></span>
                          <span class="star-rating fa fa-star-o"></span>
                          <span class="star-rating fa fa-star-o"></span>
                      ...
                      <div  style="display:inline-block; margin-left:10px;">
                         <span>3 <span class="fa fa-comment"></span> </span>
                      </div>
                  </div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed elementum molestie urna, id scelerisque leo sodales sit amet. Curabitur volutpat lorem euismod nunc tincidunt condimentum. Suspendisse gravida elementum mauris, in vulputate justo ultrices sit amet. Maecenas ultricies elit in mi sagittis fringilla.</p>
                 <div class="buttons-div">
                      ...
                      <asp:Button CssClass="my-button" ID="Button4" runat="server" Text="Add To Cart" ForeColor="#999999" CausesValidation="False" />
                      <asp:Button CssClass="my-button" ID="Button3" runat="server" Text="View Details" ForeColor="#999999" CausesValidation="False" />
                 
                      <div class="my-button favorites" ID="favorite" runat="server" style="padding:7px;">
