...
public partial class GameDetails : System.Web.UI.Page
{
    ...
    protected void GetReview()
    {
        ...
        if (reader.HasRows)
        {
            while (reader.Read())
            {
               ...
               comments.Text =  reader.GetString(2);
            }
    ...
    protected void add_update_review()
    {
        ...
        rev.AddToReview(u_id, g_id, Convert.ToInt16(ddl_rating.SelectedValue), txt_review.Text);
    }
    ...
    protected void btn_delete_Click(object sender, EventArgs e)
    {
        ...
        {
            delete_review();
            ddl_rating.SelectedValue = "Select";
            txt_review.Text = "";
            lbl_del.Text = "";
            Response.Redirect("~/Details.aspx?gid=" + g_id);
        ...
        else
        {
            ddl_rating.SelectedValue = "Select";
            txt_review.Text = "";
            lbl_del.Text = "No review to delete";
            btn_delete.Visible = true;
        }
