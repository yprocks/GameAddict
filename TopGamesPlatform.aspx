<%@ Page MasterPageFile="~/GameAddict.Master" Language="C#" AutoEventWireup="true" CodeFile="TopGamesPlatform.aspx.cs" Inherits="TopGamesPlatform" %>
...
<asp:Content ID="topContentBody" ContentPlaceHolderID="GameAddictBody" runat="server">
                    ...
                    <div class="cl">&nbsp;</div>
                           ...
                           <div class="cnt" style="margin-left: 10px;">
                               ...
                               <div class="buttons-div">
                                   ...
                                   <asp:Button CssClass="my-button" ID="btn_cart" runat="server" Text="Add To Cart" CommandArgument='<%# Eval("GamePlatformID") %>' CommandName="cart" ForeColor="#999999"  CausesValidation="false"/>
