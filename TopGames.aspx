<%@ Page MasterPageFile="~/GameAddict.Master" Language="C#" AutoEventWireup="true" CodeFile="TopGames.aspx.cs" Inherits="TopGames" %>
        ...
        <div class="block-bot">
          ...
          <div class="row-articles articles">
            <div class="cl">&nbsp;</div>
              ...
              <asp:SqlDataSource ID="SqlDataSourceAllGames" runat="server" ConnectionString="<%$ ConnectionStrings:GameAddictConnectionString %>" SelectCommand="SELECT * FROM [Game] where [Game].isActive = 1 ORDER BY [Game].Rating DESC"></asp:SqlDataSource>
